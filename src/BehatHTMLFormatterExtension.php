...
namespace lopezs\BehatHTMLFormatter;
...
class BehatHTMLFormatterExtension implements ExtensionInterface {
  ...
  public function configure(ArrayNodeDefinition $builder) {
    ...
    $builder->children()->scalarNode("embed_screenshot")->defaultValue("false");
  }
  ...
  public function load(ContainerBuilder $container, array $config) {
    $definition = new Definition("lopezs\\BehatHTMLFormatter\\Formatter\\BehatHTMLFormatter");
    ...
    $definition->addArgument($config['embed_screenshot']);
